...
cr_covid-19<- leaflet(activos_cantones_reciente) %>% 
  ...
  addPolygons(fillColor = ~paleta_azul(activos), stroke=T, fillOpacity = 1,
              ...
              group = "Cantones",
              popup = paste("Provincia: ",activos_cantones_reciente$provincia, "<br>",
                        "Cantón: ", activos_cantones_reciente$canton, "<br>",
                        "activos: ", activos_cantones_reciente$activos
                      )
  ) %>%
